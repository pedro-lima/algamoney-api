...
public class AlgaMoneyExceptionHandler extends ResponseEntityExceptionHandler {
	...
	//this is a @RequestBody conversion exception
	@Override
	...
	//tentando alterar ou remover uma entidade que nao existe
	...
	//passando o codigo de um cliente ou categoria que nao existe na hora de salvar o lancamento
	...
	public ResponseEntity<Object> handlePessoaInexistenteOuInativaException(PessoaInexistenteOuInativaException ex,
		...
		String mensagemDesenvolvedor = ex.toString();
		List<Erro> erros = Arrays.asList(new Erro(mensagemUsuario, mensagemDesenvolvedor));
		//return super.handleExceptionInternal(ex, erros, new HttpHeaders(), HttpStatus.BAD_REQUEST, request); //OU
